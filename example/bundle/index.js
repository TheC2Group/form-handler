...
jquery.extend(TextField.prototype, fieldProto);
...
jquery.extend(Select.prototype, fieldProto);
...
jquery.extend(Checkbox.prototype, fieldProto);
...
jquery.extend(Radio.prototype, fieldProto);
...
jquery(document).on('focus mousedown mouseup click change', 'select[readonly], input[type="checkbox"][readonly], input[type="radio"][readonly]', function (e) {
  e.preventDefault();
});
...
},{"../../cjs/form-handler.js":1,"jquery":3}],3:[function(require,module,exports){
/*!
 * jQuery JavaScript Library v3.4.1
 * https://jquery.com/
 *
